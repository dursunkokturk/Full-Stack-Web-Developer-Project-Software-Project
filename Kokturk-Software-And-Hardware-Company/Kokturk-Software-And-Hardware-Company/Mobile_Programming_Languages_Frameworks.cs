...
namespace Kokturk_Software_And_Hardware_Company
{
    ...
    public partial class Mobile_Programming_Languages_Frameworks
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public Mobile_Programming_Languages_Frameworks()
        {
            this.Programming_Languages = new HashSet<Programming_Languages>();
        }
    
        public short Framework_Id { get; set; }
        public Nullable<short> Mobile_Framework { get; set; }
